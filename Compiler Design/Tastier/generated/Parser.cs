...
out typeR);
	...
	void ConstDecl() {
		...
		Expect(38);
		Ident(out name);
		obj = tab.NewObj(name, constant, integer); 
		Expect(18);
		if (StartOf(3)) {
			Expr(out reg,
out type);
	...
	static readonly bool[,] set = {
		...
		{x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,T,x, x,T,x,T, T,T,T,x, x,x,x,x, x,x},
...
public class Errors {
	...
	public virtual void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 34: s = "\"writeln\" expected"; break;
